...
namespace SafebrowseTest
{
    ...
    public class ReputationStressTest
    {
        ...
        public void StressTestLocal()
        {
            ...
            Assert.IsTrue(checkTime < 5, "A check of " + NumHosts + " urls from UrlPool.dat should take less than 5 seconds. Actually took " + checkTime);
        }
        ...
        public void Initialize()
        {
            ...
            //populate seed urls
            Assert.IsTrue(dir.GetFiles().Any(file => file.Name.Equals("UrlPool.dat")), "Failed to find UrlPool.dat which is required for Stress Tests. It is expected to be in the root of the solution directory.");
